...
<body >
	...
	<div class="page-header">
		...
		<form role="form" method="post" action="http://localhost/framework/index.php/Producto/new" id="form" >
			...
			<div class="form-group">
				<label for="tipo_producto">Nombre de tipo</label>
				<div class="input-group ancho ">
				<input type="text" class="form-control has-feedback" id="tipo_producto" 
				placeholder="Introduzca el nombre del nuevo tipo de producto" >
				</div>
			</div>
			
			
			<button type="submit" class="btn btn-primary" id="crear"  data-target="#popupCrearTipoProducto">Crear</button>
		</form>
	...
	<!-- popup producto -->
	<div class="modal fade" id="popupCrearTipoProducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> 
